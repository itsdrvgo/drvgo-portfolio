            ...
            (
                ...
                >
                    ...
                    <div tw="flex flex-col">
                        ...
                        <div
                            tw="flex text-white text-5xl font-bold w-3/4 leading-tight"
                            style={{
                                fontFamily: "Cal Sans",
                                fontWeight: "bold",
                            }}
                        >
                            Open Source Portfolio build using Next.JS v13,
                            ShadCN UI, Drizzle ORM, Tailwind CSS, PlanetScale
                            MySQL & More...
                        </div>
                    </div>
