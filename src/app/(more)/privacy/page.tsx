            ...
            <div className="container max-w-[75rem] space-y-8 p-0">
                ...
                <div className="prose prose-base max-w-full text-white prose-headings:text-white prose-p:text-gray-200 prose-strong:text-white prose-li:text-gray-300">
                    ...
                    <p>
                        ...
                        data you provide to us when using our website. By
                        accessing or using DRVGO, you agree to the terms of this
                        Privacy Policy.
                    </p>
                    ...
                    <p>
                        ...
                        information. We use industry-standard security protocols
                        to ensure the confidentiality and integrity of your
                        data.
                    </p>
                    ...
                    <p>
                        ...
                        policies, and we encourage you to review them to
                    ...
                    <p>
                        ...
                        child, please contact us, and we will take steps to
                    ...
                    <p>
                        By using DRVGO, you agree to the terms of this Privacy
                        Policy. It is essential to keep your privacy and data
                        protection policies up to date and compliant with
                        applicable laws and regulations. This Privacy Policy is
                        a template and may need to be reviewed and customized
                        according to your specific website and data practices.
                    </p>
                </div>
            </div>
        </section>
