...
5. Tweaking Project Environment
    ...
    > You can also set global environment variables, which is a nice touch. Everytime you update the **dev.nix** file, it will ask you to rebuild the environment. Read more about it <Link href="https://developers.google.com/idx/guides/customize-idx-env">here</Link>.
